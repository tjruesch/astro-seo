...
noarchive | boolean | Set this to true if you don't want search engines to cache your page. Since this is an SEO component, this gets set to `false` by default. This way, not archiving pages is strictly opt-out.
